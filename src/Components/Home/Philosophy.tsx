...
export default function Philosophy() {
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-[#000000] border-t border-neutral-800 overflow-hidden">
      ...
      {/* Content Container */}
      <div className="container relative z-10 px-6 mx-auto pt-10 sm:pt-24 pb-14">
        {/* Section Header */}
        <motion.div
        ...
        >
          <h2 className="text-4xl md:text-6xl font-light tracking-tight text-neutral-100 mb-10">
            <span className=" font-medium sm:pb-0 text-transparent bg-clip-text bg-gradient-to-r from-neutral-200 to-neutral-300/90">
              Nexo Mark
            </span>{" "}
            <br />
            <p className="pt-3">Where Vision Meets Reality</p>
          </h2>
        </motion.div>
